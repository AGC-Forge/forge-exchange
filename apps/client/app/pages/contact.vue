...
useSeoMeta({
  title: "Contact Us — Smart Boost Labs",
  description:
    "Get in touch with the Smart Boost Labs team. We respond within 24 hours.",
});
...
<template>
  <div>
    <!-- Page Header -->
    <section
      class="relative bg-white dark:bg-neutral-950 border-b border-neutral-200/50 dark:border-neutral-800/50"
    >
      ...
      <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div class="space-y-6">
            <!-- Contact Info Card -->
            <div
              class="bg-white dark:bg-neutral-900 border border-neutral-200/60 dark:border-neutral-800/60 rounded-2xl p-7"
            >
              <h3
              ...
              <div class="space-y-5">
                <div class="flex items-start gap-4">
                  <div
                    class="flex items-center justify-center w-10 h-10 rounded-xl bg-green-50 dark:bg-green-950/50 shrink-0"
                  >
                    <UIcon
                      name="i-lucide-mail"
                  ...
                  <div>
                    <p
                      class="text-sm text-neutral-500 dark:text-neutral-400 mb-0.5"
                    >
            ...
            >
              ...
              <div class="flex items-center gap-3">
                <a
                  href="#"
                  class="flex items-center justify-center w-10 h-10 rounded-xl bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 hover:bg-green-50 dark:hover:bg-green-900/30 hover:text-green-600 dark:hover:text-green-400 transition-all duration-200"
                >
